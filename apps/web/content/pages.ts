...
const sharedFeatures = {
  images: ['/img/screenshots/jobs.png', '/img/screenshots/metrics.png'] as const,
}
  ...
  en: {
    ...
    faq: {
      ...
      items: [
        ...
        { question: 'What happens when I downgrade?', answer: 'The exact rule that selects which jobs stay active has not been decided. Before a downgrade is confirmed, Postqron must show which jobs will remain active and the selection criterion. Your work will not be deleted silently.' },
  ...
  it: {
    ...
    faq: {
      ...
      items: [
        ...
        { question: 'Cosa succede quando faccio un downgrade?', answer: 'La regola esatta che sceglie quali job restano attivi non è ancora stata decisa. Prima della conferma, Postqron deve mostrare quali resteranno attivi e il criterio di selezione. Il tuo lavoro non verrà cancellato in silenzio.' },
  ...
  es: {
    ...
    faq: {
      ...
      items: [
        ...
        { question: '¿Qué ocurre al bajar de plan?', answer: 'La regla exacta para elegir qué trabajos siguen activos aún no se ha decidido. Antes de confirmar, Postqron debe mostrar cuáles seguirán activos y el criterio de selección. Tu trabajo no se eliminará en silencio.' },
  ...
  de: {
    ...
    faq: {
      ...
      items: [
        ...
        { question: 'Was passiert bei einem Downgrade?', answer: 'Die genaue Regel dafür, welche Jobs aktiv bleiben, ist noch nicht beschlossen. Vor der Bestätigung muss Postqron die betroffenen Jobs und das Auswahlkriterium anzeigen. Deine Arbeit wird nicht stillschweigend gelöscht.' },
  ...
  fr: {
    ...
    faq: {
      ...
      items: [
        ...
        { question: 'Que se passe-t-il lors d’un passage à une offre inférieure ?', answer: 'La règle exacte qui détermine les tâches restant actives n’est pas encore décidée. Avant confirmation, Postqron doit afficher les tâches concernées et le critère de sélection. Votre travail ne sera pas supprimé silencieusement.' },
