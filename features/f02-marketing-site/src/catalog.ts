...
export const PRICING_COPY: Readonly<Record<PricingLocale, PricingCopy>> = {
  en: {
    ...
    quantityOverMax: '{count} or more',
    planGroupLabel: 'Choose a plan',
    selectedPlanAnnouncement: 'Selected plan: {plan}',
  ...
  it: {
    ...
    quantityOverMax: '{count} o più',
    planGroupLabel: 'Scegli un piano',
    selectedPlanAnnouncement: 'Piano selezionato: {plan}',
  ...
  es: {
    ...
    quantityOverMax: '{count} o más',
    planGroupLabel: 'Elige un plan',
    selectedPlanAnnouncement: 'Plan seleccionado: {plan}',
  ...
  fr: {
    ...
    quantityOverMax: '{count} ou plus',
    planGroupLabel: 'Choisissez un abonnement',
    selectedPlanAnnouncement: 'Abonnement sélectionné : {plan}',
  ...
  de: {
    ...
    quantityOverMax: '{count} oder mehr',
    planGroupLabel: 'Wähle einen Tarif',
    selectedPlanAnnouncement: 'Ausgewählter Tarif: {plan}',
