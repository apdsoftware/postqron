...
- queues account or Owner-authorized workspace exports, accepts only SHA-256
  described artifacts, keeps packages for seven days, and issues authenticated
  signed links for at most 24 hours;
...
- supports an explicit immediate-finalization choice and cancellation during the
  grace period without restoring sessions, tokens, or cancelled jobs;
