...
| Not verified ("Mailronix") | Subprocessor | Transactional email delivery (account, security and service notifications) | Recipient email address; recipient name; transactional message content | Not verified | Not verified | Not applicable — no verified source | Not available | Internal API contract only (`features/f14-email/contracts/mailronix-api-1.0.0.md`); not a public legal source |
...
- **"Mailronix" could not be verified.** No official company website, legal page, DPA, or subprocessor list could be located for a real company operating under this name via primary-source research. This entry cannot be published as approved until Postqron's vendor-management function confirms the exact contracting legal entity and supplies its official documentation.
