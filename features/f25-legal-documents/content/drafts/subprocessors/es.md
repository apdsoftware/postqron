...
- **Mailronix / Apdsoftware di Carlo Zuffetti**: la página oficial mailronix.com/terms declara públicamente la entidad operadora como "Apdsoftware di Carlo Zuffetti", Via C. Colombo 15, 24047 Treviglio (BG), Italia, P.IVA 03835250162, e indica que el descriptor de la transacción "può essere comune ad altri prodotti della stessa ditta" (puede ser compartido con otros productos de la misma empresa) — coherente con que "APDSoftware" sea la misma marca mencionada en otras partes de este corpus como operadora de Postqron, aunque la propia página de mailronix.com no nombra expresamente a Postqron. **Punto por resolver en la revisión legal**: si se confirma que Mailronix y Postqron están operados por la misma entidad legal, no se trataría de una relación ordinaria de subencargado entre partes independientes, sino del mismo responsable/encargado utilizando un sistema con marca separada, lo que afecta a cómo se aplica el art. 28 del RGPD (una entidad no puede ser subencargada de sí misma) y requiere una calificación precisa por parte del asesor legal, en lugar de la clasificación ordinaria de proveedor mantenida aquí de forma provisional.
