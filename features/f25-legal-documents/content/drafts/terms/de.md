...
Diese Bedingungen regeln den Zugang zu und die Nutzung des Dienstes, einschließlich der öffentlichen Website, der Anwendung und aller verbundenen Integrationen. Durch die Nutzung des Dienstes oder durch die ausdrückliche Annahme dieser Bedingungen bei der Kontoregistrierung erklärt sich der Nutzer mit der zu diesem Zeitpunkt vorgelegten genauen Version und dem Inhalts-Digest dieser Bedingungen einverstanden. Postqron führt eine interne Aufzeichnung darüber, welche Version und welchen Digest jeder Nutzer akzeptiert hat und wann. Bei Nichtzustimmung darf der Dienst nicht genutzt werden.

## 3. B2C- und B2B-Kunden

Während dieser MVP-Phase wird Postqron ausschließlich Verbrauchern und Unternehmen angeboten, die in Italien ansässig oder niedergelassen sind. Die öffentlichen Marketing-Seiten des Dienstes können von jedem Ort aus eingesehen werden, jedoch erfordern die Kontoregistrierung und der Kauf eines kostenpflichtigen Plans ein italienisches Vertragsland und eine italienische Rechnungsadresse. Die Unterscheidung zwischen Verbrauchern (B2C) und Unternehmen (B2B) ist für diese Bedingungen durchgängig relevant, da sie die geltenden vorvertraglichen Informationspflichten, die Verfügbarkeit und den Umfang des gesetzlichen Widerrufsrechts sowie die im Streitfall verfügbaren Rechtsbehelfe und Verfahren bestimmt. Gilt eine Bestimmung nur für Verbraucher oder nur für Unternehmen, wird dies ausdrücklich angegeben.

## 4. Konten und Arbeitsbereiche

Bei der ersten Anmeldung eines Nutzers beim Dienst wird automatisch ein persönlicher Arbeitsbereich (Workspace) erstellt. Innerhalb eines Arbeitsbereichs bestehen zwei Rollen: der Inhaber (Owner), der die Mitglieder des Arbeitsbereichs, die verbundenen Social-Media-Kanäle, den Abonnementplan und die Löschung des Arbeitsbereichs verwalten kann, sowie das Mitglied (Member), das über einen vom Inhaber konfigurierten, eingeschränkteren operativen Zugriff verfügt. Jeder Nutzer ist für die Vertraulichkeit seiner Zugangsdaten sowie für sämtliche unter seinem Konto durchgeführten Aktivitäten verantwortlich, einschließlich aller Inhalte, die über die mit seinem Arbeitsbereich verbundenen Social-Media-Konten veröffentlicht werden.

## 5. Zulässige Nutzung

Nutzer dürfen den Dienst nicht verwenden, um rechtswidrige, Rechte Dritter verletzende oder missbräuchliche Inhalte zu veröffentlichen, zu planen oder zu verbreiten. Postqron veröffentlicht auf verbundenen Social-Media-Plattformen ausschließlich über die von diesen Plattformen offiziell unterstützten APIs. Nutzer dürfen nicht versuchen, Ratenbegrenzungen (Rate Limits), Planberechtigungen zu umgehen oder Zugang zu dem in Abschnitt 6 beschriebenen nicht öffentlichen internen unbegrenzten Plan zu erlangen. Verstöße gegen diesen Abschnitt können zur Sperrung oder Kündigung des Kontos führen, unbeschadet weiterer Postqron nach diesen Bedingungen oder geltendem Recht zustehender Rechtsbehelfe.
...
Ein Upgrade — eine Erhöhung der Planstufe, ein Wechsel des Abrechnungsrhythmus auf jährlich oder eine Erhöhung der Anzahl verbundener Kanäle — wird unmittelbar nach Zahlung des von Paddle für den verbleibenden aktuellen Abrechnungszeitraum berechneten anteiligen Betrags wirksam. Ein Downgrade wird zum Ende des bereits bezahlten Zeitraums wirksam, ohne automatische Gutschrift oder Erstattung für den ungenutzten Teil des höheren Plans. Führt ein Downgrade dazu, dass der Arbeitsbereich Ressourcen aufweist, die die Grenzen des neuen Plans übersteigen, werden diese überschüssigen Ressourcen pausiert und nicht gelöscht, bis sie wieder innerhalb der geltenden Grenzen liegen.

## 10. Kündigung

Der Inhaber des Arbeitsbereichs kann ein kostenpflichtiges Abonnement entweder direkt im Dienst oder über das Kundenportal von Paddle kündigen. Standardmäßig wird die Kündigung zum Ende des bereits bezahlten Zeitraums wirksam, wobei der Plan bis dahin aktiv bleibt. Eine sofortige Kündigung, die vor Ablauf des bezahlten Zeitraums wirksam wird, ist Fällen von Erstattung, Betrugsverdacht, gesetzlicher Verpflichtung oder dokumentierter Eingriffnahme des Kundensupports vorbehalten. Die Kündigung eines Abonnements führt nicht zur Löschung des Kontos oder der damit verbundenen Daten und ist von dem in der Datenschutzerklärung von Postqron beschriebenen Kontolöschungsverfahren zu unterscheiden.
...
Im nach zwingendem geltendem Recht größtmöglich zulässigen Umfang beschränkt sich die Haftung von Postqron, die sich aus diesen Bedingungen oder der Nutzung des Dienstes ergibt, auf tatsächlich erlittene unmittelbare Schäden und schließt mittelbare, beiläufige oder Folgeschäden aus, einschließlich entgangenen Gewinns, entgangener Einnahmen, Daten- oder Geschäftschancenverlusts. Nichts in diesen Bedingungen beschränkt oder schließt eine Haftung aus, die nach zwingendem geltendem Recht nicht rechtmäßig beschränkt oder ausgeschlossen werden kann, einschließlich der Haftung für grobe Fahrlässigkeit, Vorsatz, Tod oder Personenschäden sowie gesetzlicher Verbraucherrechte, auf die vertraglich nicht verzichtet werden kann.

## 15. Anwendbares Recht und Gerichtsstand

Diese Bedingungen unterliegen italienischem Recht. Für Verbraucher entzieht diese Rechtswahl ihnen nicht den Schutz, den ihnen die zwingenden Bestimmungen des Rechts ihres Staates des gewöhnlichen Aufenthalts gewähren, soweit die anwendbaren Vorschriften der Europäischen Union über grenzüberschreitende Verbraucherverträge (insbesondere die Rom-I-Verordnung) dies vorsehen. Für Streitigkeiten unter Beteiligung eines Verbrauchers ist das nach anwendbarem Recht zuständige Gericht dasjenige seines Wohnsitzes. Für Streitigkeiten zwischen Postqron und einem Geschäftskunden (B2B) ist das Gericht Bergamo zuständig, der Sitz der Vertragspartei Apdsoftware di Carlo Zuffetti (Via C. Colombo 15, 24047 Treviglio (BG), Italien).
...
Postqron kann diese Bedingungen von Zeit zu Zeit ändern. Eine wesentliche Änderung erfordert die aktive erneute Annahme der neuen Version durch den Nutzer, bevor die weitere Nutzung authentifizierter Funktionen des Dienstes gestattet ist. Eine unwesentliche Änderung wird als neue Version dieser Bedingungen veröffentlicht, ohne dass eine erneute Annahme erforderlich ist. Jede veröffentlichte Version dieser Bedingungen ist nach ihrer Herausgabe unveränderlich und wird durch einen eindeutigen Inhalts-Digest gekennzeichnet, der zusammen mit der entsprechenden, in Abschnitt 2 beschriebenen Annahmeaufzeichnung gespeichert wird.
