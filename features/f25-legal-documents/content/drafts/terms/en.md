...
These Terms govern access to and use of the Service, including the public website, the application, and any connected integrations. By using the Service, or by actively accepting these Terms during account signup, you agree to be bound by the exact version and content digest of these Terms presented to you at that time. Postqron maintains an internal record of which version and digest each user accepted, and when. If you do not agree to these Terms, you must not use the Service.

## 3. B2C and B2B customers

During this MVP phase, Postqron is offered exclusively to consumers and businesses that are resident, or established, in Italy. The public marketing pages of the Service may be viewed from any location, but account signup and purchase of any paid plan require an Italian contracting country and an Italian billing address. The distinction between consumers (B2C) and businesses (B2B) matters throughout these Terms because it determines the applicable pre-contractual information duties, the availability and scope of statutory withdrawal rights, and the remedies and procedures available in the event of a dispute. Where a provision applies only to consumers or only to businesses, this is stated expressly.

## 4. Accounts and workspaces

A personal workspace is automatically created the first time a user logs in to the Service. Within a workspace, two roles exist: the Owner, who may manage workspace members, connected social-media channels, the subscription plan and workspace deletion; and the Member, who has more limited operational access as configured by the Owner. Each user is responsible for maintaining the confidentiality of their account credentials and for all activity carried out under their account, including any content published through the social media accounts connected to their workspace.

## 5. Acceptable use

Users must not use the Service to publish, schedule or distribute content that is illegal, infringing of third-party rights, or abusive. Postqron publishes to connected social media platforms exclusively through those platforms' officially supported APIs. Users must not attempt to circumvent rate limits, plan entitlements, or gain access to the non-public internal unlimited plan described in Section 6. Violations of this Section may result in suspension or termination of the account, in addition to any other remedy available to Postqron under these Terms or applicable law.
...
An upgrade — an increase in plan tier, a change of billing cadence to annual, or an increase in the number of connected channels — takes effect immediately upon payment of the prorated amount calculated by Paddle for the remainder of the current billing period. A downgrade takes effect at the end of the period already paid for, with no automatic credit or refund for the unused portion of the higher plan. Where a downgrade would leave the workspace with resources exceeding the new plan's limits, those excess resources are paused, not deleted, until they again fit within the applicable limits.

## 10. Cancellation

The workspace Owner may cancel a paid subscription either directly within the Service or through the Paddle customer portal. By default, cancellation takes effect at the end of the period already paid for, and the plan remains active until then. Immediate cancellation, effective before the end of the paid period, is reserved for cases involving a refund, suspected fraud, a legal obligation, or a documented customer-support intervention. Cancelling a subscription does not delete the account or any associated data, and is a distinct process from the account-deletion flow described in Postqron's Privacy Policy.

## 11. Withdrawal and cooling-off rights
...
To the maximum extent permitted by applicable mandatory law, Postqron's liability arising out of or in connection with these Terms or the use of the Service is limited to direct damages actually suffered, and excludes indirect, incidental or consequential loss, including loss of profits, revenue, data or business opportunity. Nothing in these Terms limits or excludes any liability that cannot lawfully be limited or excluded under applicable mandatory law, including liability for gross negligence, wilful misconduct, death or personal injury, and any statutory rights available to consumers that cannot be waived by agreement.
...
Postqron may amend these Terms from time to time. A material change requires active re-acceptance of the new version by the user before continued use of authenticated features of the Service is permitted. A non-material change is published as a new version of these Terms without requiring re-acceptance. Every published version of these Terms is immutable once issued and is identified by a unique content digest, which is recorded together with the corresponding acceptance record described in Section 2.
